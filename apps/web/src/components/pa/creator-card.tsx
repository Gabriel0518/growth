...
export function CreatorCard({ creator, delivery, campaign }: CreatorCardProps): ReactNode {
  return (
    <Link
      ...
      className="block rounded-pa-lg border border-pa-border bg-pa-surface p-pa-4 transition-[border-color,box-shadow] duration-[120ms] hover:border-pa-border-strong hover:shadow-pa-1 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pa-ring"
    >
